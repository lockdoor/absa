...
classDiagram
    ...
    namespace DataLayer {
        ...
        class BaseData{
            <<abstract>>
            #client: Client ~supabase | postgres~
            #logger: Logger
            #_log(message, level, kwargs) None
        }
        class ReviewDataPostgresClient {
            <<concrete>>
        }

        class ReviewDataSupabaseClient {
            <<concrete>>
        }
    ...
    ABC <|-- BaseData
    BaseData --o Logger : has (optional)
    BaseData <|-- BatchData
    BaseData <|-- AspectData
    BaseData <|-- ReviewData
    ReviewData <|.. ReviewDataSupabaseClient : implement
    ReviewData <|.. ReviewDataPostgresClient : implement
